...
//    final int SMALLER_FONT_SIZE = HEIGHT/40;
    ...
    private final String url = "/main/java";
    private final String fontURL = "file:src/main/java/emulogic.ttf";
//    @Override
...
//    }
    ...
    private void setupLabels(int fontSize, Label... bs){
        for (int i = 0; i < bs.length; i++) {
            Label b = bs[i];
            b.setFont(Font.loadFont(fontURL, fontSize));
            b.setBackground(backgroundBack);
            b.setTextFill(labelFrontColor);
    ...
    private void createNodes(){
        ...
        NESFont = Font.loadFont(fontURL, FONT_SIZE);
...
//                blackFrame.add(new JButton("Exit"));
        ...
        cityLabel.setFont(Font.loadFont(fontURL, TITLE_FONT_SIZE));
